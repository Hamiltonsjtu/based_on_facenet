                    ...
                    try:
                        ...
                        if nrof_faces > 0:
                            ...
                            for i, det in enumerate(det_arr):
                                ...
                                det_arry_dlib = dlib.rectangle(left=int(xmin), top=int(ymax), right=int(xmax),
                                                               bottom=int(ymin))

                                # Get the the face's pose
                                scaled = face_aligner.align(534, img, det_arry_dlib,
                                                                 landmarkIndices=open_Face.AlignDlib.OUTER_EYES_AND_NOSE)
