import sys
# sys.path.append("dlib")  # useful for the import of facenet in another folder
import numpy as np
import dlib
import cv2
import open_Face
...
for i, face_rect in enumerate(detected_faces):
	...
	alignedFace = face_aligner.align(534, image, face_rect, landmarkIndices=open_Face.AlignDlib.OUTER_EYES_AND_NOSE)
