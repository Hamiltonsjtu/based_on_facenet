...
def get_args():
    ...
    parser.add_argument('--model_path', type=str, default=r'E:\Face\InsightFace\config_ms1m_200_200k', help='model path')
    parser.add_argument('--read_path', type=str, default=r'F:\TEST_crop', help='path to image file or directory to images')
...
if __name__ == '__main__':
    ...
    if args.mode == 'build':
        ...
        with tf.Session(config=tf_config) as sess:
            ...
            print('loading...')
            saver = tf.train.import_meta_graph(args.model_path + '/best-m-200000.meta')
            saver.restore(sess, args.model_path + '/best-m-200000')
