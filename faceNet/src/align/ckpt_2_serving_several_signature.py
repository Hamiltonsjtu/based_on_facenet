...
export_path_base = './MTCNN_severable_update'
...
with tf.Session() as sess:
    ...
    prediction_pnet_signature = (
            tf.saved_model.signature_def_utils.build_signature_def(
                    inputs={'pnet_images': tensor_info_pnet_images},
    ...
    prediction_rnet_signature = (
            tf.saved_model.signature_def_utils.build_signature_def(
                    inputs={'rnet_images': tensor_info_pnet_images},
                    outputs={'rnet_face': tensor_info_rnet_face,
                             'rnet_bbox': tensor_info_rnet_bbox
                            },
                    method_name = tf.saved_model.signature_constants.REGRESS_METHOD_NAME))


    prediction_onet_signature = (
            tf.saved_model.signature_def_utils.build_signature_def(
                    inputs={'onet_images': tensor_info_pnet_images},
                    outputs={
    ...
    builder.add_meta_graph_and_variables(
            ...
            signature_def_map={
                    'pnet_ouput': prediction_pnet_signature,
                    'rnet_ouput': prediction_rnet_signature,
                    'onet_ouput': prediction_onet_signature
